...
class WorksheetGeneratorFlow(Flow):
    ...
    def __init__(self, user_id: str, chat_id: str, subject_id: str):
        ...
        self.content_retriever = ContentRetrieverTool(user_id=user_id, chat_id=chat_id, subject_id=subject_id)
        self.content_saver = ContentSaverTool(user_id=user_id, chat_id=chat_id, subject_id=subject_id)
