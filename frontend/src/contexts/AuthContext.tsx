...
interface AuthContextType {
  ...
  verifyEmail: (verifyData: EmailVerification) => Promise<any>;
  signup: (signupData: SignUp) => Promise<any>;
  forgotPassword: (forgotData: ForgotPassword) => Promise<any>;
  resetPassword: (resetData: ResetPassword) => Promise<any>;
  logout: () => Promise<void>;
...
export const AuthProvider: React.FC<AuthProviderProps> = ({ children }) => {
  ...
  const login = async (loginData: Login): Promise<any> => {
    setLoading(true);
    try {
  ...
  const verifyEmail = async (verifyData: EmailVerification): Promise<any> => {
    setLoading(true);
    try {
  ...
  const signup = async (signupData: SignUp): Promise<any> => {
    setLoading(true);
    try {
  ...
  const forgotPassword = async (forgotData: ForgotPassword): Promise<any> => {
    setLoading(true);
    try {
  ...
  const resetPassword = async (resetData: ResetPassword): Promise<any> => {
    setLoading(true);
    try {
