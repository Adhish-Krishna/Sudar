...
const ActivityCard = ({title, type, created_at, navigateTo}:ActivityCardProps)=>{
    ...
    return(
        <>
            <button className="relative w-full h-20 bg-background border rounded-2xl flex flex-row justify-start items-center gap-5 p-3 cursor-pointer" onClick={()=>navigate(navigateTo)}>
